...
urlpatterns = [
    ...
    path('skill_analysis/student_company_choice/', views.student_company_choice_view, name='student_company_choice'),
    path('internship/delete/<int:choice_id>/', views.delete_internship_choice, name='delete_internship_choice'),
    ...
    path('delete_skill/<path:skill_name>/', views.delete_skill, name='delete_skill'),
